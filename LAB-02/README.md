...
8. Вопросы по схеме:
   ...
   * Какой порт отображается в качестве альтернативного и в настоящее время заблокирован? Почему протокол spanning-tree выбрал этот порт в качестве невыделенного (заблокированного) порта?
     * Altn port S3 - E0/1 при равенстве cost, поскольку BID имеет наибольшее значение за счет наибольшего Mac Address. 
...
12. Вопросы по схеме:
    ...
    * Почему протокол STP выбрал эти порты в качестве портов корневого моста на этих коммутаторах?
      * Потому что порты с наименьшим номером предпочтительнее при выборе приоритета.
13. Общие вопросы:
